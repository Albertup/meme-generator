  ...
  return (
    <>
      <div ref={memeRef} className="c-card">
        ...
        <img data-testid={"card--img-" + data.id} src={data.url} alt={memeTexts.name}/>
        ...
        <button data-testid={"card--button-" + data.id} onClick={downloadMeme}><i class="fa fa-arrow-circle-down" ></i></button>
      </div>
    </>
  );
}
